    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="sticky top-0 z-10 flex justify-between items-center px-6 md:px-12 py-3 border-b border-gray-100 bg-white shadow-md">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="flex items-center cursor-pointer gap-1 px-4 py-2 bg-linear-to-r from-orange-500 to-amber-500 text-white font-bold rounded-full text-base shadow-lg transition duration-200 ease-out text-[15px]"
        >
